...
},
{
 ...
 document.getElementById("finalResult").innerHTML="your result is " + ((totalScore*2)) + " from 10 <br> Your Leve is HardLevel <br>"   ;
var x=document.createElement('a');
x.innerHTML="click me";
document.getElementById("finalResult").appendChild(x).href="hardLevel.html";
 }
 else if(score1>5) {
 showScore.innerHTML="Score : "+((totalScore*2))+"%";
 document.getElementById("finalResult").innerHTML="your result is " + ((totalScore*2))+ " from 10 <br> Your Leve is Intermediate Level  <br>" ;
var x=document.createElement('a');
x.innerHTML="click me";
document.getElementById("finalResult").appendChild(x).href="IntermediateLevel.html";
 }
 else {
  showScore.innerHTML="Score : "+((totalScore*2))+"%";
 document.getElementById("finalResult").innerHTML="your result is " + ((totalScore*2))+ " from 10 <br>  Your Leve is Easy  Level <br>  ";
var x=document.createElement('a');
x.innerHTML="click me";
document.getElementById("finalResult").appendChild(x).href="easeyLevel.html";
